...
cf-2021-update-specified-coldfusion-1  | Updating webroot to /app
cf-2021-update-specified-coldfusion-1  | Configuring virtual directories
cf-2021-update-specified-coldfusion-1  | Updating password
cf-2021-update-specified-coldfusion-1  | Serial Key: Not Provided       
cf-2021-update-specified-coldfusion-1  | Previous Serial Key: Not Provided
cf-2021-update-specified-coldfusion-1  | Starting ColdFusion
...
```
